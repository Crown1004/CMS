...
@section('content')
    ...
    <div class="col-md-8">
        {{-- if no posts include alerts.empty --}}
        @includeWhen(count($posts) == 0, 'alerts.empty', ['message' => __('لا يوجد منشورات')])
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-3">
                                    <i class="fa-solid fa-comment"></i> <span
                                        class="text-secondary">{{ $post->comments->count() }} {{ __('تعليقات') }}</span>
                                </div>
                            </div>
