@includeWhen(!count($contents->posts), 'alerts.empty', ['message' => __('لا يوجد أي منشورات بعد')])
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-3">
                        <i class="fa-solid fa-comment"></i> <span class="text-secondary">{{ $post->comments->count() }}
                            {{ __('تعليقات') }}</span>
                    </div>
                </div>
